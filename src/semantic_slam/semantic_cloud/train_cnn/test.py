...
def test():
    # model
    model_name ='segnet'
    checkpoint_path = '/home/hitwzh/semantic_slam_ws/src/semantic_slam/pre_catkin_ws/src/pre2018/seg_cnn/training/2018-06-19/segnet_sunrgbd_best_model.pkl'
    # dataset
    dataset = 'sunrgbd'
    n_classes = 38
    ...
    # Setup image
    image_path = '/home/hitwzh/semantic_slam_ws/src/semantic_slam/datasets/SUNRGBD/test/img-000048.jpg'
