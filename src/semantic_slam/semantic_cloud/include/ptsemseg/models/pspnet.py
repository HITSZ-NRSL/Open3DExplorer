...
if __name__ == '__main__':
    ...
    caffemodel_dir_path = '/home/hitwzh/semantic_slam_ws/src/semantic_slam/models'
    ...
    #psp.load_state_dict(convert_state_dict(torch.load('/home/hitwzh/semantic_slam_ws/src/semantic_slam/models/pspnet_101_pascalvoc.pth')['model_state']))

    psp.float()
    psp.cuda(cd)
    psp.eval()

    dataset_root_dir = '/home/hitwzh/semantic_slam_ws/src/semantic_slam/datasets/VOC/VOCdevkit/VOC2012'
    ...
    checkpoints_dir_path = '/home/hitwzh/semantic_slam_ws/src/semantic_slam/models'
