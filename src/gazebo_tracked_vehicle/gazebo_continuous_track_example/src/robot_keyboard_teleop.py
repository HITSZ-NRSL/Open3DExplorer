...
##################################################################################
# set_position_outnone = [-5, 14.5, 1.6,-2, -13, -5, 2]     #slope scene
...
#         print('1w:',count_stage)
#         print('last_position:',(set_position_outnone[0])-global_position[0])
#         return 'w'
#     elif  count_stage == 0:
...
#     # print count_stage
#     if count_stage == 1 and global_position[0] < (last_position + set_position_outnone[1]):
#         print('2w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[1])-global_position[0])
#         return 'w'
#     elif count_stage == 1:
#         print('2w')
#         last_position = global_position[0]
...
#     # print count_stage
#     if count_stage == 2 and global_position[0] < (last_position + set_position_outnone[2]):
#         print('3w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[2])-global_position[0])
#         return 'w'
#     elif count_stage == 2:
#         print('3w')
...
#     # print count_stage
#     if count_stage == 3 and global_position[5] > -0.707:
#         print('4e:',count_stage)
#         return 'e'
#     elif count_stage == 3:
#         last_position = global_position[0]
#         count_stage = 4
...
#     # print count_stage
#     if count_stage == 4 and global_position[0] > (last_position + set_position_outnone[3]):
#         print('5w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[3])-global_position[0])
#         return 'w'
#     elif count_stage == 4:
#         last_position = global_position[0]
#         speed = .1
...
#     # print count_stage
#     if count_stage == 5 and global_position[0] > (last_position + set_position_outnone[4]):
#         print('6w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[4])-global_position[0])
#         return 'w'
#     elif count_stage == 5:
#         speed = .03
#         turn = .03
...
#     if count_stage == 6 and global_position[0] > (last_position + set_position_outnone[5]):
#         print('7w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[5])-global_position[0])
#         return 'w'
#     elif count_stage == 6:
#         last_position = global_position[1]
#         count_stage = 7
...
#     # print count_stage
#     if count_stage == 7 and global_position[5] < -0.7:
#         print('8e', count_stage)
#         return 'e'
#     elif count_stage == 7:
#         last_position = global_position[0]
#         count_stage = 8

#     if count_stage == 8 and global_position[0] < (last_position + set_position_outnone[6]):
#         print('9w', count_stage)
#         print('last_position:',(last_position + set_position_outnone[6])-global_position[0])
#         return 'w'
#     elif count_stage == 8:
#         global runloop_flag
#         runloop_flag = 0
...
set_position_outnone = [(4.6-dis), -(2.0+dis), -(6.4+dis), -(3.6+dis), -(3.1-dis), -(2.0+dis), 6.1+dis, -(3.6+dis), 5+dis]    # grass_water_terrain_random
...
##################################################################################
##################################################################################
# set_position_outnone = [-7, 12, 12, -12, -3]     #genral scene
...
# set_position_outnone = [-9, 4, 7, -4]     #### inrich & outrich
...
#     # print count_stage
#     if count_stage == 1 and global_position[6] > 0:
#         print('2e:',count_stage)
#         return 'e'
#     elif count_stage == 1:
#         last_position = global_position[1]
...
#     # print count_stage
#     if count_stage == 2 and global_position[1] < (last_position + set_position_outnone[1]):
#         print('3w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[1])-global_position[1])
#         return 'w'
#     elif count_stage == 2:
#         # speed = .03
#         # turn = .03
...
#     # print count_stage
#     if count_stage == 3 and global_position[6] > -0.707:
#         print('4e', count_stage)
#         print('last_position:',last_position)
#         return 'e'
#     elif count_stage == 3:
...
#     # print count_stage
#     if count_stage == 4 and global_position[0] < (last_position + set_position_outnone[2]):
#         print('5w:',count_stage)
#         print('last_position:',(last_position + set_position_outnone[2])-global_position[0])
#         return 'w'
#     elif count_stage == 4:
...
#     # print count_stage
#     if count_stage == 5 and global_position[6] > -0.9995:
#         print('6e', count_stage)
#         print('last_position:',last_position)
#         return 'e'
#     elif count_stage == 5:
#         last_position = global_position[1]
...
#     if count_stage == 6 and global_position[1] > (last_position + set_position_outnone[3]):
#         print('7w', count_stage)
#         print('last_position:',(last_position + set_position_outnone[3])-global_position[1])
#         return 'w'
#     elif count_stage == 6:
#         count_stage = 7
    
#         # print count_stage
#     if count_stage == 7 and global_position[5] < 0.707:
#         print('8e', count_stage)
#         print('last_position:',last_position)
#         return 'e'
#     elif count_stage == 7:
...
if __name__=="__main__":
    ...
    control_turn = 0
    # count_key = 0
    # control_list = ['i', 'i', 'i', 'i', 'i', 'l', 'l', 'l', 'l']
    try:
        print msg
        ...
        while(1):
            ...
            # key = control_list[count_key]
            # count_key = count_key + 1
            # if count_key >= len(control_list):
            #     count_key = 0
            if runloop_flag == 1:
                if (key == '\x03'):
                    print "exit"
